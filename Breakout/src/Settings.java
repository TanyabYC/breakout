...
public class Settings {
	...
	/** Added to allow it to be changed in future and used in several classes */
	public static final Color BACKGROUND_COLOUR = Color.WHITE;	
	
	/** Added to correct the right border of the screen */
	public static final int RIGHT_SCREEN_MARGIN = 15;
